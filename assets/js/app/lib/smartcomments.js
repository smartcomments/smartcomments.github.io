define(function(require, exports, module) {
	...
	var esprima = require('lib/esprima'),
	    eswalker = require('lib/walker'),
	    //verga = require('../templates/default.js'),
	    SmartComments = {
	        ...
	        initialize: function(config) {
	            ...
	            instance.template = require('../templates/default.js');
	            try {
	...
	exports.initialize = SmartComments.initialize;
	exports.generate = SmartComments.generate;
